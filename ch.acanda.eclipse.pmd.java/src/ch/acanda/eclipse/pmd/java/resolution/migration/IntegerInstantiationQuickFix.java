 ...
 * "http://pmd.sourceforge.net/http://pmd.sourceforge.net/pmd-5.1.1/rules/java/migrating.html#IntegerInstantiation"
 * >IntegerInstantiation</a>. It replaces an integer instantiation with auto boxing.
 *
 * @author Philip Graf
 */
public class IntegerInstantiationQuickFix extends ASTQuickFix<ClassInstanceCreation> {

    private final Pattern ARGUMENT = Pattern.compile("\\((.*)\\)");

    public IntegerInstantiationQuickFix(final PMDMarker marker) {
        super(marker);
    }
