...
import static ch.acanda.eclipse.pmd.domain.LocationContext.FILESYSTEM;
...
public final class PMDPropertyPageModelTransformer {
     ...
     */
    private static final Function<RuleSetModel, RuleSetViewModel> TO_RULESETVIEWMODEL = new Function<RuleSetModel, RuleSetViewModel>() {
        @Override
        public RuleSetViewModel apply(final RuleSetModel domainModel) {
            return toViewModel(domainModel);
        }
    };
     ...
     */
    public static Iterable<RuleSetViewModel> toViewModels(final Iterable<RuleSetModel> domainModels) {
        return transform(domainModels, TO_RULESETVIEWMODEL);
    }
    
    /**
     * Transforms a rule set domain model to a rule set view model.
     */
    public static RuleSetViewModel toViewModel(final RuleSetModel ruleSetModel) {
        ...
        return new RuleSetViewModel(name, type, location);
    }
